...
Unofficial scripts for installing Pterodactyl Panel & Wings. Works with the older version of ptero
...
```bash
bash <(curl -s https://raw.githubusercontent.com/BigGorillaBoi/ptero-inst/refs/heads/master/INSTALLSCRIPT)
```
